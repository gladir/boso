<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admintypeactionlist.aspx.cs" Inherits="admintypeactionlist" %>
...
<body>
    ...
    <asp:datagrid id="TypeActionDataGrid" runat="server" OnSortCommand="TypeActionDataGrid_EventHandler" OnItemCommand="TypeActionDataGrid_Command" OnItemDataBound="TypeActionDataGrid_OnItemDataBound" GridLines="None" 
		...
		<Columns>
		    <asp:BoundColumn DataField="TypeActionId" Visible="False" />
			<asp:HyperLinkColumn DataTextField="MID" DataNavigateUrlField="TypeActionId" DataNavigateUrlFormatString="admintypeactionedit.aspx?Id={0}" SortExpression="MID" />
