<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminlanguageedit.aspx.cs" Inherits="adminlanguageedit" %>
...
<body>
    ...
    <div><asp:TextBox ID="TextBoxMID" runat="server" Width="50px" MaxLength="15"></asp:TextBox></div>
